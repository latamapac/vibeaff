...
const navItems = [
  ...
  { href: "/admin/ai-assistant", label: "AI Assistant", icon: "ai" },
  { href: "/admin/payouts", label: "Payouts", icon: "payouts" },
  { href: "/admin/enrollments", label: "Enrollments", icon: "access" },
  { href: "/admin/commissions", label: "Commissions", icon: "payouts" },
  { href: "/admin/promo-codes", label: "Promo Codes", icon: "channels" },
  { href: "/admin/webhooks", label: "Webhooks", icon: "integrations" },
  { href: "/admin/api-keys", label: "API Keys", icon: "access" },
  { href: "/admin/leaderboard", label: "Leaderboard", icon: "leaderboard" },
  { href: "/admin/access", label: "Access Matrix", icon: "access" },
  { href: "/admin/channels", label: "Channels", icon: "channels" },
        ...
        <header className="sticky top-0 z-40 backdrop-blur-xl bg-[#050508]/80 border-b border-white/[0.06]">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            <Link href="/admin" className="flex items-center gap-2.5">
              ...
              <span className="text-[10px] font-mono text-[#8B8B9E] uppercase tracking-widest ml-1">Admin</span>
            </Link>
